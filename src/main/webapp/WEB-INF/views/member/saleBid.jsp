         ...
         <div class="row p-5">
            <div class="col-6" style="height: auto; width: 250px;">
               <div class="row" style="margin-bottom: 50px;">
                  ...
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
                     <a href="/member/saleBid" style="text-decoration: none; color: black; font-weight: bold;">판매내역</a>
                  </div>
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
            ...
            <div class="col-9 sm-12">
               <div class="row">
                  <h3 style="font-weight: bold;">판매내역</h3>
                  <div class="col-12 mb-3 m-0"
                     ...
                     <div class="row" style="margin-top: 25px; text-align: center;">
                        <div class="col-6 m-0">
                           <a href="/member/saleBid" style="text-decoration: none; color: black;"><h4 id=countBid></h4>
                           <h5 style="font-weight: bold; width: 100px; margin: auto">입찰진행중</h5></a>
                        </div>
                        <div class="col-6 m-0">
                           <a href="/member/saleEnd" style="text-decoration: none; color: #a0a0a0;"><h4>${count }</h4>
                           <h5 style="font-weight: normal; width: 100px; margin: auto">판매완료</h5></a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row p-0 m-auto">
                     <div class="col-12"
                        ...
                        <a style="text-decoration: none; color: black;" href="/product/getProductDetail?parentSeq=${saleList[status.index].parentSeq }">
                        <div class="row">
                           ...
                           <div class="col-2 d-none d-lg-block" style="margin-top: 55px; text-align: center; font-size:1.2rem; font-weight:bold;">
                              ${saleList[status.index].formedPrice }원
                           </div>
                        </div>
                        </a>
                     </div>
