...
<body>
	...
	<div class="container mt-5 text-center">
		<div class="row mt-5">
			<div class="col mb-4">
				<h3 style="font-weight: bold; margin-bottom: 40px;">PW 확인</h3>
				<hr align="center" style="width: 350px; height: 2px; margin:auto;   background-color: black;">
				<h6 align="left" style="width: 350px; margin:auto; margin-top: 40px; margin-bottom: 20px;">가입 시 등록한 비밀번호를 입력해 주세요.</h6>
			</div>
		</div>
<!-- 		onsubmit="return false" 추가하면 아이디 찾기 첫 화면 페이지 전환 되는 오류 해결됨 -->
		<form action="/member/mtPagePwCheck" method="post" id="form" onsubmit="return false" >
			<div class="row text-center">
				...
				<div class="col-12 mt-3 mb-4 login-action">
					<div class="row loginOption">
						<div class="col-12">
							<input type="submit" value="확인" id="find" class="btn text-white" style="width: 350px; height: 45px; background-color:#222222;">
						</div>
					</div>
				</div>
			</div>
	 	...
	 	if ($("#pw").val() == "") {
			...
			$.ajax({
				...
				if(resp != "") {
	     			...
	     			$("#pwCheck").val("")
	                $("#pw").focus()
	                location.replace("/member/myPagePw") 
	     		}
			})
		});
	</script>
