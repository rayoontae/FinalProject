               ...
               <div class="row" style="margin-bottom: 50px;">
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
                     <a href="/member/purchaseBid"
                        style="text-decoration: none; color: black; font-weight: bold;">구매내역</a>
                  </div>
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
               ...
               <div class="row">
                  ...
                  <div class="col-12 mb-3 m-0"
                     ...
                     <div class="row" style="margin-top: 25px; text-align: center;">
                        <div class="col-6 m-0">
                           <a href="/member/purchaseBid" style="text-decoration: none; color: #a0a0a0;"><h4>${count }</h4>
                           <h5 style="font-weight: normal; width: 100px; margin: auto">입찰진행중</h5></a>
                        </div>
                        <div class="col-6 m-0">
                           <a href="/member/purchaseEnd" style="text-decoration: none; color: black;"><h4 id=countEnd></h4>
                           <h5 style="font-weight: bold; width: 100px; margin: auto">구매완료</h5></a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row p-0 m-auto">
                     <div class="col-12"
                        ...
                        <div class="row">
                           ...
                           <div class="col-2 d-none d-lg-block" style="margin-top: 45px; text-align: center;">
                              <span style="font-size:1.2rem; font-weight:bold">${bList[status.index].formedPrice }원</span><br>
                              ${bList[status.index].formedDate }
                           </div>
                        </div>
                        </a>
                     </div>
