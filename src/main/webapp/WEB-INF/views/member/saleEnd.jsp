               ...
               <div class="row">
                  ...
                  <div class="col-12 mb-3 m-0"
                     ...
                     <div class="row" style="margin-top: 25px; text-align: center;">
                        <div class="col-6 m-0">
                           <a href="/member/saleBid" style="text-decoration: none; color: #a0a0a0;"><h4>${count }</h4>
                           <h5 style="font-weight: normal; width: 100px; margin: auto">입찰진행중</h5></a>
                        </div>
                        <div class="col-6 m-0">
                           <a href="/member/saleEnd" style="text-decoration: none; color: black;"><h4 id=countEnd></h4>
                           <h5 style="font-weight: bold; width: 100px; margin: auto">판매완료</h5></a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row p-0 m-auto">
                     <div class="col-12" style="width: 948px; height: 150px; min-width: 400px; border: solid 1px #dcdcdc;">
                        ...
                        <div class="row">
                           ...
                           <div class="col-2 d-none d-lg-block" style="margin-top: 55px; text-align: center;">
                              <span style="font-size:1.2rem; font-weight:bold">${saleList[status.index].formedPrice }원</span><br>
                              ${saleList[status.index].formedDate }
                           </div>
                        </div>
                        </a>
                     </div>
