      ...
      <div class="container-menu">
         <div class="row p-5">
            <div class="col-6" style="height: auto; width: 250px;">
               <div class="row" style="margin-bottom: 50px;">
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
                     <a href="/member/purchaseBid" style="text-decoration: none; color: black; font-weight: bold;">구매내역</a>
                  </div>
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
                  ...
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
                     <a href="/member/myProduct"
                        style="text-decoration: none; color: black;">관심상품</a>
                  </div>
                  <div class="col-12 mb-2 m-0 " style="color: #bebebe;">
            ...
            <div class="col-9 sm-12">
               <div class="row">
                  <h3 style="font-weight: bold;">구매내역</h3>
                  <div class="col-12 mb-3 m-0"
                     style="width: 948px; height: 115px; min-width: 400px; border-top: solid 4px black; border-bottom: solid 1px black;">
                     <div class="row" style="margin-top: 25px; text-align: center;">
                        <div class="col-6 m-0">
                           <a href="/member/purchaseBid" style="text-decoration: none; color: black;"><h4 id=countBid></h4>
                           <h5 style="font-weight: bold; width: 100px; margin: auto">입찰진행중</h5></a>
                        </div>
                        <div class="col-6 m-0">
                           <a href="/member/purchaseEnd" style="text-decoration: none; color: #a0a0a0;"><h4>${count }</h4>
                           <h5 style="font-weight: normal; width: 100px; margin: auto">구매완료</h5></a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row p-0 m-auto">
                     <div class="col-12"
                        style="width: 948px; height: 150px; min-width: 400px; border: solid 1px #dcdcdc;">
                        <a style="text-decoration: none; color: black;" href="/product/getProductDetail?parentSeq=${bList[status.index].parentSeq }">
                        <div class="row">
                           ...
                           <div class="col-6" style="margin-top: 15px; min-width: 235px;">
                              <span style="font-weight: bold;">${pList[status.index].brand }</span><br> <span>
                                 ${pList[status.index].title }</span><br> <span>${pList[status.index].name }</span><br>
                              <br>
                              <c:if test="${saleList[status.index].sized ne 0 }">
                                 <span>${saleList[status.index].sized }</span>
                              </c:if>
                           </div>
                           <div class="col-2 d-none d-lg-block" style="margin-top: 55px; text-align: center; font-size:1.2rem; font-weight:bold;">
                              ${bList[status.index].formedPrice }원
                           </div>
                        </div>
                        </a>
                     </div>
...
//       console.log("${fn:length(pList) }")
   let countBid = "${fn:length(pList) }";
   $("#countBid").text(countBid)
