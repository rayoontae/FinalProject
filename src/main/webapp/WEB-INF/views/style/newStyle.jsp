...
<body>
    ...
    <div class="container">
      <div class="row mt-4">
        <div class="col-12">
          <div class="row">
            <div class="col-12 text-center style"><a href="/style/toStyleMain">STYLE</a></div>
            <!-- <div class="col-4"></div> -->
          </div>
        </div>
      </div>
      <div class="row btnbar text-center">
        ...
        <div class="col-md-4 col-12 my-auto">
          <button class="btn detailMainBtn orderBtn" type="button" id="current" >#최신</button>
    ...
    <div class="container p-0 current" id="currentCon">
      <div class="row mt-5 m-0 stList" id="test">
      	<c:set value="0" var="beginvalue"/>

      <c:forEach var = "i" items = "${listByNew }" varStatus="status">
        <div class="col-6 col-lg-3 md-Mb" id="list${status.index}">
          <div class="row p-2">
            <!-- 스타일 게시글 이미지 출력 -->
            ...
            <div class="col-12 mt-3 m-0">
              <div class="row">
                ...
                <!-- 좋아요 -->
		            ...
		            <c:if test="${i.likey != 0 }">
		                  <span class="me-3 heartCount">${i.likey }</span>
		            </c:if>
