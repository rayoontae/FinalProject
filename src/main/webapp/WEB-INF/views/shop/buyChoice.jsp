   ...
   <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 mt-5 m-0" style="text-align: center;">
                <input type="text" value="즉시 구매하기" id="uppertitle" style = "text-align:center;" disabled>
            </div>
            <div class="col col-sm col-md col-lg-3"></div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 mt-3 m-0">
                <div class="row">
                    <div class="col-6" style="text-align:center ;" >
                        <button class="btn-nobg2" id="bid">구매 입찰</button>
                    </div>
                    <div class="col-6" style="text-align:center ;">
                        <button class="btn-nobg2" id="purchase">즉시 구매</button>
                    </div>    
                </div>
            </div>
            <div class="col col-sm col-md col-lg-3">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 mt-1 m-0">
                <button class="btn-nobg3" id="finalbtn">즉시 구매 계속 </button>
            </div>
            <div class="col col-sm col-md col-lg-3">
            </div>
        </div>
...
//         })
        ...
        $("#purchase").on("click",function(){
          ...
          $("#choiceCondition").val("즉시 구매가")
          $("#finalbtn").text("즉시 구매 계속")
          $("#uppertitle").val("즉시 구매하기")
        ...
        $("#bid").on("click",function(){
          ...
          $("#choiceCondition").val("구매 희망가")
          $("#finalbtn").text("구매 입찰 계속")
          $("#uppertitle").val("구매 입찰하기")
...
//             
        ...
        $("#finalbtn").on("click",function(){
           if($("#underline").val()!="" && $("#underline").val()>=minimumPrice){
              location.href="/product/getPaymentCheck?parentSeq="+${productDetail[0].seq}+"&finalPrice="+$("#underline").val()+"&sized="+${sized}+"&result="+$("#result").val()
           }else{
              alert("가격을 알맞게 입력주세요")
              return false;
           }
