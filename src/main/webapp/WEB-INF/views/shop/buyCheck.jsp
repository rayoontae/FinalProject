...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light mdMainNav d-block d-md-none">
      <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12">
                <div class="row m-auto mt-3 p-4" style="background-color:white; height:770px; max-width:700px;">
                    <div class="col-12">
                        <div class="row mt-1">
                            <div class="col-12">
                                <h3 style="font-weight:bold; padding:0px;"><span style="color:red;">구매</span>하시기 전에 꼭 확인하세요.</h3>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                           <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                               <img src="/upload/${sysNameOneImage}" style="width:85%; height:200px; object-fit:cover; margin-left:10px;">
                           </div>
                           <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                               <br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                ...
                                <span style="font-size:14px; color:darkgrey;">모든 구성품이 그대로이며, 한 번도 착용하지 않은 정품·새상품입니다. 국내 발매 상품 여부는 확인드리지 않습니다.</span>
                            </div>
                            <div class="col-2" style="display:flex; justify-content: center; align-items: center;">
                            ...
                            <div class="col-10">
                                ...
                                <span style="font-size:14px; color:darkgrey;">박스/패키지와 상품 컨디션에 민감하시다면 검수 기준을 반드시 확인하시기 바랍니다.</span>
                            </div>
                            <div class="col-2" style="display:flex; justify-content: center; align-items: center;">
                        ...
                        <div class="row">
                            <div class="col-12 text-center" id="toNext" onclick="toNext()" style="width:95%; height:50px; margin:0 auto; margin-top:20px; background-color:#ebebeb; border-radius:10px; font-size:1.5rem; color:white; display:flex; justify-content: center; align-items: center;">
                                구매 계속
                            </div>
                        </div>
    ...
    <input type="hidden" value="${sized}" >
   <input type="hidden" value="${parentSeq}" >
   <input type="hidden" value="${buyPrice}" >
   <input type="hidden" value="${sellPrice}" >
   <input type="hidden" value="${sysNameOneImage}">
       ...
       $(function(){
        ...
        function toNext() {
            if($(".cb:checked").length < 4) {
                ...
                location.href="/product/getBuyChoice?parentSeq="+${parentSeq}+"&sized="+${sized}+"&buyPrice="+${buyPrice}+"&sellPrice="+${sellPrice}+"&releasePrice="+${releasePrice};
